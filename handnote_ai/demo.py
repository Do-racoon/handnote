    ...
    with torch.no_grad():
        for image_info in demo_loader:
            ...
            for pred, pred_max_prob,line,wordH in zip(preds_str, preds_max_prob,image_line,image_wordH):
                ...
                i_test_list.append((pred+ " ",line,wordH))
...
if __name__ == '__main__':
    img_list = tesseract_box.tesseract_box('test_eng.png')
    parser = argparse.ArgumentParser()
    parser.add_argument('--img_data', default =img_list, help='path to image_folder which contains text images')
